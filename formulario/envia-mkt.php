...
$nomeremetente     = $_POST['nomeremetente-mkt'];
$emailremetente    = trim($_POST['emailremetente-mkt']);
$emaildestinatario = 'dudu@webitout.com.br'; // Digite seu e-mail aqui, lembrando que o e-mail deve estar em seu servidor web
$ddd      	   	   = $_POST['ddd'];
$telefone      	   = $_POST['telefone-mkt'];
$assunto          = $_POST['assunto-mkt'];
$outros          = $_POST['outros-mkt'];
$mensagem          = $_POST['mensagem-mkt'];
 
 
/* Montando a mensagem a ser enviada no corpo do e-mail. */
$mensagemHTML = '<P>FORMULARIO PREENCHIDO NA SESSAO MARKETING</P>
