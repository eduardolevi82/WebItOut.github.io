...
$nomeremetente     = $_POST['nomeremetente-cx'];
$emailremetente    = trim($_POST['emailremetente-cx']);
$emaildestinatario = 'dudu@webitout.com.br'; // Digite seu e-mail aqui, lembrando que o e-mail deve estar em seu servidor web
$ddd      	   	   = $_POST['ddd'];
$telefone      	   = $_POST['telefone-cx'];
$assunto          = $_POST['assunto-cx'];
$outros          = $_POST['outros-cx'];
$mensagem          = $_POST['mensagem-cx'];
 
 
/* Montando a mensagem a ser enviada no corpo do e-mail. */
$mensagemHTML = '<P>FORMULARIO PREENCHIDO NA SESSAO CRIAÇÃO XPRESS</P>
