...
$nomeremetente     = $_POST['nomeremetente-web'];
$emailremetente    = trim($_POST['emailremetente-web']);
$emaildestinatario = 'dudu@webitout.com.br'; // Digite seu e-mail aqui, lembrando que o e-mail deve estar em seu servidor web
$ddd      	   	   = $_POST['ddd'];
$telefone      	   = $_POST['telefone-web'];
$assunto          = $_POST['assunto-web'];
$outros          = $_POST['outros-web'];
$mensagem          = $_POST['mensagem-web'];
 
 
/* Montando a mensagem a ser enviada no corpo do e-mail. */
$mensagemHTML = '<P>FORMULARIO PREENCHIDO NA SESSAO WEBDESIGN</P>
